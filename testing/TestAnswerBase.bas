...
'@TestMethod("AnswerBase")
Private Sub isoTime_WhenSetValid_ShouldSet()
    On Error GoTo TestFail
...
'@TestMethod("AnswerBase")
Private Sub isoOffset_WhenSetValidIsoTime_ShouldGetOffset()
    On Error GoTo TestFail
...
'@TestMethod("AnswerBase")
Private Sub isoTime_WhenSetInvalidValid_ShouldThrow()
    Const ExpectedError As Long = CustomError.ModelValidationError
    On Error GoTo TestFail
...
'@TestMethod("AnswerBase")
Private Sub isoTime_WhenSetTruncatedTime_ShouldThrow()
    Const ExpectedError As Long = CustomError.ModelValidationError
    On Error GoTo TestFail
...
'@TestMethod("AnswerBase")
Private Sub description_WhenGet_ShouldBeNilLength()
    On Error GoTo TestFail
